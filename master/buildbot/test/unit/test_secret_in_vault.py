...
class TestSecretInVaultHttpFakeBase(
    ConfigErrorsMixin, TestReactorMixin, unittest.TestCase
):
...
class TestSecretInVaultV1(TestSecretInVaultHttpFakeBase):
    ...
    def testReconfigSecretInVaultService(self):
        ...
        yield self.srvcVault.reconfigService(
            vaultServer="serveraddr", vaultToken="someToken"
        )
