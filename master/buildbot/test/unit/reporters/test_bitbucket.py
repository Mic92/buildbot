...
class TestBitbucketStatusPushConfig(ConfigErrorsMixin, unittest.TestCase):
    def test_auth_error(self):
        with self.assertRaisesConfigError(
            ...
            BitbucketStatusPush(
                oauth_key="abc", oauth_secret="abc1", auth=("user", "pass")
            )
...
class TestBitbucketStatusPushRepoParsing(TestReactorMixin, unittest.TestCase):
    ...
    def test_parse_with_scheme(self):
        self.assertEqual(
            ("user", "repo"), self.parse("https://bitbucket.com/user/repo.git")
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ("user", "repo"), self.parse("ssh://git@bitbucket.com/user/repo.git")
        )
        self.assertEqual(
