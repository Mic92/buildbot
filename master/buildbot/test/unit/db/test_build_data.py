...
class Tests(interfaces.InterfaceTests):
    common_data = [
        ...
        fakedb.Build(
            id=40, buildrequestid=43, number=9, masterid=88, builderid=89, workerid=47
        ),
    ]
    ...
    def test_add_data_get_data_no_value(self):
        ...
        data_dict = yield self.db.build_data.getBuildDataNoValue(
            buildid=30, name="mykey"
        )
        validation.verifyDbDict(self, "build_datadict", data_dict)
        self.assertEqual(
            data_dict,
    ...
    def test_remove_old_build_data(
        ...
        yield self.insert_test_data(
            ...
            + [
                ...
                fakedb.BuildData(
                    id=91, buildid=50, name="name1", value=b"value1", source="src1"
                ),
                fakedb.BuildData(
                    id=92, buildid=50, name="name2", value=b"value2", source="src2"
                ),
                fakedb.BuildData(
                    id=93, buildid=51, name="name3", value=b"value3", source="src3"
                ),
                fakedb.BuildData(
                    id=94, buildid=51, name="name4", value=b"value4", source="src4"
                ),
                fakedb.BuildData(
                    id=95, buildid=52, name="name5", value=b"value5", source="src5"
                ),
                fakedb.BuildData(
...
class TestFakeDB(
    Tests, connector_component.FakeConnectorComponentMixin, unittest.TestCase
):
    @defer.inlineCallbacks
    def setUp(self):
