...
class TestGitHubPullrequestPoller(
    ...
    def simple_pr(self, project=None):
        ...
        self.assertEqual(
            change["revlink"], "https://github.com/buildbot/buildbot/pull/4242"
        )
        self.assertEqual(change["branch"], "defunkt/change")
        self.assertEqual(
            change["repository"], "https://github.com/defunkt/buildbot.git"
        )
        self.assertEqual(change["files"], ["README.md"])
        self.assertEqual(change["committer"], "defunktc <defunktc@defunkt.null>")
        self.assertEqual(
            change["project"], project if project is not None else "buildbot/buildbot"
        )
    ...
    def test_magicLink(self):
        ...
        self.assertEqual(
            change["repository"], "https://github.com/buildbot/buildbot.git"
        )
        self.assertEqual(change["files"], ["README.md"])
        self.assertEqual(change["committer"], "defunktc <defunktc@defunkt.null>")
        self.assertDictSubset(_GH_PARSED_PROPS, change["properties"])
