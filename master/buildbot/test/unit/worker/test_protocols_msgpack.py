...
class TestListener(TestReactorMixin, unittest.TestCase):
    ...
    def test_update_registration_simple(self):
        ...
        self.assertEqual(
            self.master.msgmanager._registrations, [("tcp:1234", "example", "pass")]
        )
    ...
    def test_update_registration_pass_changed(self):
        ...
        self.assertEqual(
            self.master.msgmanager._unregistrations, [("tcp:1234", "example")]
        )
    ...
    def test_create_connection(self):
        ...
        listener.before_connection_setup.assert_called_once_with(
            protocol, worker.workername
        )
...
class TestConnection(TestReactorMixin, unittest.TestCase):
    ...
    def test_start_stop_keepalive_timer(self):
        ...
        self.assertEqual(
            self.protocol.get_message_result.call_args_list, expected_calls
        )
    ...
    def test_remote_get_worker_info(self):
        self.protocol.get_message_result.return_value = defer.succeed(
            {"system": "posix"}
        )
    ...
    def test_remote_start_command_args_update(
        self, arg_name, arg_value, expected_value
    ):
