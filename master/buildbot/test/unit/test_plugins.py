...
class TestFindDistributionInfo(unittest.TestCase):
    def test_exists_in_1st_ep(self):
        ...
        with mock.patch(
            "buildbot.plugins.db.distributions", return_value=distributions
        ):
...
class TestBuildbotPlugins(unittest.TestCase):
    ...
    @mock.patch(
        "buildbot.plugins.db.find_distribution_info", fake_find_distribution_info
    )
    ...
    @mock.patch(
        "buildbot.plugins.db.find_distribution_info", fake_find_distribution_info_dups
    )
