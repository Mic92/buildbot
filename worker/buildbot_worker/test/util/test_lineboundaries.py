...
class LBF(unittest.TestCase):
    ...
    def test_split_terminal_control(self):
        ...
        self.assertEqual(
            self.lbf.append("1234\033[1;2H4321", 2.0), ("1234\n", [4], [2.0])
        )
        self.assertEqual(self.lbf.flush(), ("4321\n", [4], [2.0]))
        self.assertEqual(
            self.lbf.append("1234\033[1;2f4321", 3.0), ("1234\n", [4], [3.0])
        )
        self.assertEqual(self.lbf.flush(), ("4321\n", [4], [3.0]))
    ...
    def test_long_lines(self):
        ...
        self.assertEqual(
            self.lbf.append("123456789012345", 3.0),
            ("8901212345678901234\n", [19], [2.0]),
        )
