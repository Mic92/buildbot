    ...
    def insert_initial_data(self):
        self.master.db.insert_test_data(
            [
                ...
                fakedb.Change(
                    changeid=1, branch="master", revision="1234abcd", sourcestampid=1
                ),
                ...
                fakedb.Log(
                    id=1, name="stdio", slug="stdio", stepid=1, complete=1, num_lines=10
                ),
                fakedb.Log(
                    id=2, name="stdio", slug="stdio", stepid=2, complete=1, num_lines=20
                ),
                fakedb.Log(
                    id=3, name="stdio", slug="stdio", stepid=3, complete=1, num_lines=30
                ),
                fakedb.Log(
                    id=11,
                    name="stdio",
                ...
                fakedb.LogChunk(
                    logid=1, first_line=0, last_line=2, content="o line1\no line2\n"
                ),
                fakedb.LogChunk(
                    logid=1, first_line=2, last_line=3, content="o line3\n"
                ),
                fakedb.LogChunk(
                    logid=2,
                    first_line=0,
