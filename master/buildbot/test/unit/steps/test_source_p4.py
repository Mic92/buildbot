...
class TestP4(
    sourcesteps.SourceStepMixin, TestReactorMixin, ConfigErrorsMixin, unittest.TestCase
):
    def setUp(self):
    ...
    def _incremental(
        self, client_stdin="", extra_args=None, workdir="wkdir", timeout=20 * 60
    ):
    ...
    def test_worker_connection_lost(self):
        ...
        self.expect_commands(
            ExpectShell(workdir="wkdir", command=["p4", "-V"]).error(
