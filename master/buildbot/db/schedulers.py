...
class SchedulersConnectorComponent(base.DBConnectorComponent):
    ...
    def getChangeClassifications(
        ...
        def thd(conn):
            ...
            q = sa.select(
                [sch_ch_tbl.c.changeid, sch_ch_tbl.c.important], whereclause=wc
            )
    ...
    def setSchedulerMaster(self, schedulerid, masterid):
        def thd(conn):
            ...
            try:
                ...
                conn.execute(
                    q, {"schedulerid": schedulerid, "masterid": masterid}
                ).close()
    ...
    def getSchedulers(self, active=None, masterid=None, _schedulerid=None):
        def thd(conn):
            ...
            join = sch_tbl.outerjoin(
                sch_mst_tbl, (sch_tbl.c.id == sch_mst_tbl.c.schedulerid)
            )
