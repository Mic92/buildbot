...
class UsersTests(TestReactorMixin, unittest.TestCase):
    ...
    def test_createUserObject_git(self):
        yield users.createUserObject(
            self.master, "Tyler Durden <tyler@mayhem.net>", "git"
        )
    ...
    def test_createUserObject_svn(self):
        ...
        self.assertEqual(
            self.db.users.users_info,
            {1: [{"attr_type": "svn", "attr_data": "tdurden"}]},
        )

    @defer.inlineCallbacks
    def test_createUserObject_hg(self):
        yield users.createUserObject(
            self.master, "Tyler Durden <tyler@mayhem.net>", "hg"
        )
    ...
    def test_createUserObject_cvs(self):
        ...
        self.assertEqual(
            self.db.users.users_info,
            {1: [{"attr_type": "cvs", "attr_data": "tdurden"}]},
        )
    ...
    def test_createUserObject_darcs(self):
        ...
        self.assertEqual(
            self.db.users.users_info,
            {1: [{"attr_type": "darcs", "attr_data": "tyler@mayhem.net"}]},
        )
    ...
    def test_createUserObject_bzr(self):
        ...
        self.assertEqual(
            self.db.users.users_info,
            {1: [{"attr_type": "bzr", "attr_data": "Tyler Durden"}]},
        )
    ...
    def test_getUserContact_found(self):
        ...
        contact = yield users.getUserContact(
            self.master, contact_types=["email"], uid=1
        )
    ...
    def test_getUserContact_key_not_found(self):
        ...
        contact = yield users.getUserContact(
            self.master, contact_types=["blargh"], uid=1
        )
