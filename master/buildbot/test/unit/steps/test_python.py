...
class BuildEPYDoc(TestBuildStepMixin, TestReactorMixin, unittest.TestCase):
    ...
    def test_sample(self):
        ...
        self.expect_outcome(
            result=FAILURE, state_string="epydoc warn=1 err=3 (failure)"
        )
...
class PyLint(TestBuildStepMixin, TestReactorMixin, unittest.TestCase):
    ...
    def test_error(self, name, store_results):
        ...
        self.expect_outcome(
            result=FAILURE, state_string="pylint error=1 warning=1 (failure)"
        )
    ...
    def test_failure(self):
        ...
        self.expect_outcome(
            result=FAILURE, state_string="pylint fatal=1 warning=1 (failure)"
        )
        self.expect_property("pylint-warning", 1)
...
class PyFlakes(TestBuildStepMixin, TestReactorMixin, unittest.TestCase):
    ...
    def test_success(self):
        ...
        self.expect_commands(
            ExpectShell(workdir="wkdir", command=["make", "pyflakes"]).exit(0)
        )
    ...
    def test_unused(self):
        ...
        self.expect_outcome(
            result=WARNINGS, state_string="pyflakes unused=1 (warnings)"
        )
    ...
    def test_undefined(self):
        ...
        self.expect_outcome(
            result=FAILURE, state_string="pyflakes undefined=1 (failure)"
        )
    ...
    def test_redefs(self):
        ...
        self.expect_outcome(
            result=WARNINGS, state_string="pyflakes redefs=1 (warnings)"
        )
    ...
    def test_importstar(self):
        ...
        self.expect_commands(
            ExpectShell(workdir="wkdir", command=["make", "pyflakes"])
            .stdout(
                "foo.py:1: 'from module import *' used; unable to detect undefined names\n"
            )
            .exit(1)
        )
        self.expect_outcome(
            result=WARNINGS, state_string="pyflakes import*=1 (warnings)"
        )
...
class TestSphinx(TestBuildStepMixin, TestReactorMixin, unittest.TestCase):
    ...
    def test_warnings(self):
        ...
        self.expect_outcome(
            result=WARNINGS, state_string="sphinx 2 warnings (warnings)"
        )
