...
class MaildirSource(MaildirService, util.ComparableMixin):
    ...
    def __init__(self, maildir, prefix=None, category="", repository=""):
        ...
        if prefix and not prefix.endswith("/"):
            log.msg(
                f"MaildirSource: you probably want your prefix=('{prefix}') to end with "
                "a slash"
            )
...
class CVSMaildirSource(MaildirSource):
    ...
    def __init__(
        self, maildir, prefix=None, category="", repository="", properties=None
    ):
...
class BzrLaunchpadEmailMaildirSource(MaildirSource):
    ...
    def __init__(
        self, maildir, prefix=None, branchMap=None, defaultBranch=None, **kwargs
    ):
