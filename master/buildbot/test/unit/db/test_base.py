...
class TestBase(unittest.TestCase):
    ...
    def test_hashColumns_unicode_ascii_match(self):
        self.assertEqual(
            self.comp.hashColumns("master"), self.comp.hashColumns("master")
        )


class TestBaseAsConnectorComponent(
    unittest.TestCase, connector_component.ConnectorComponentMixin
):
...
class TestCachedDecorator(unittest.TestCase):
    ...
    def test_cached(self):
        ...
        self.assertEqual(
            (res1, res2, comp.invocations), ("foofoo", "barbar", ["foo", "bar"])
        )
