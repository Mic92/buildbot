...
class Tests(interfaces.InterfaceTests):
    ...
    backgroundData = [
        ...
        fakedb.Step(
            id=101, buildid=30, number=1, name="one", started_at=TIMESTAMP_STEP101
        ),
        fakedb.Step(
            id=102, buildid=30, number=2, name="two", started_at=TIMESTAMP_STEP102
        ),
    ]
    ...
    def test_appendLog_getLogLines(self):
        ...
        self.assertEqual((yield self.db.logs.appendLog(logid, "XYZ\n")), (1, 1))
        self.assertEqual(
            (yield self.db.logs.getLogLines(201, 6, 7)), "yet another line\nabc\n"
        )
