...
class TestPBManager(unittest.TestCase):
    ...
    def test_register_unregister(self):
        ...
        username = yield disp.requestAvatarId(
    ...
    def test_requestAvatarId_noinitLock(self):
        ...
        self.assertTrue(
            d.called, "requestAvatarId should have been called since the lock is free"
        )
    ...
    def test_requestAvatarId_initLock(self):
        ...
        try:
            ...
            d = disp.requestAvatarId(credentials.UsernamePassword(b"boris", b"pass"))
            self.assertFalse(
                d.called, "requestAvatarId should block until the lock is released"
            )
        finally:
