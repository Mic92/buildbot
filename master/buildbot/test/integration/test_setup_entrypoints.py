...
class TestSetupPyEntryPoints(unittest.TestCase):
    ...
    def test_steps(self):
        ...
        self.verify_plugins_registered(
            "steps", "buildbot.steps", IBuildStep, known_not_exported
        )
    ...
    def test_util(self):
        ...
        if parse_version(twisted.__version__) < parse_version("18.9.0"):
            raise SkipTest(
                "manhole.py can not be imported on old twisted and new python"
            )
        ...
        self.verify_plugins_registered(
            "util", "buildbot.util", None, known_not_exported
        )
    ...
    def test_reporters(self):
        ...
        self.verify_plugins_registered(
            "reporters", "buildbot.reporters", None, known_not_exported
        )
    ...
    def test_secrets(self):
        ...
        self.verify_plugins_registered(
            "secrets", "buildbot.secrets", None, known_not_exported
        )
    ...
    def test_workers(self):
        ...
        self.verify_plugins_registered(
            "worker", "buildbot.worker", IWorker, known_not_exported
        )
            ...
            for existing_module in existing_modules:
                ...
                for name, obj in inspect.getmembers(module):
                    ...
                    if inspect.isclass(obj) and obj.__module__ == existing_module:
                        if interface is not None and not self.class_provides_iface(
                            interface, obj
                        ):
                            continue
