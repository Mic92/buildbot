...
class Tests(interfaces.InterfaceTests):
    ...
    def test_complete_set_with_test_counts(self):
        ...
        yield self.db.test_result_sets.completeTestResultSet(
            91, tests_passed=12, tests_failed=2
        )
...
class TestRealDB(unittest.TestCase, connector_component.ConnectorComponentMixin, Tests):
    ...
    def setUp(self):
        ...
        self.db.test_result_sets = test_result_sets.TestResultSetsConnectorComponent(
            self.db
        )
