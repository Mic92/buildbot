...
class TestOldBuildCanceller(TestReactorMixin, unittest.TestCase):
    ...
    def test_reconfig_defers_finished_builds_to_after_registration(self):
        ...
        ss_dict1 = self.create_ss_dict(
            "project1", "codebase1", "repository1", "branch1"
        )
        ss_dict2 = self.create_ss_dict(
            "project2", "codebase2", "repository2", "branch2"
        )
        ...
        self.master.mq.callConsumer(
            ("buildrequests", "10", "complete"), {"buildrequestid": 10}
        )
        self.master.mq.callConsumer(
