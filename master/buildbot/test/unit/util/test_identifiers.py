...
class Tests(unittest.TestCase):
    ...
    def test_forceIdentifier_too_long(self):
        self.assertEqualUnicode(
            identifiers.forceIdentifier(10, "abcdefghijKL"), "abcdefghij"
        )

    def test_forceIdentifier_invalid_chars(self):
        self.assertEqualUnicode(
            identifiers.forceIdentifier(100, "my log.html"), "my_log_html"
        )
    ...
    def test_incrementIdentifier_add_digits(self):
        self.assertEqualUnicode(
            identifiers.incrementIdentifier(100, "aaa_99"), "aaa_100"
        )
