...
class Tests(interfaces.InterfaceTests):
    ...
    def test_signature_get(self):
        ...
        def get(
            self, path, filters=None, fields=None, order=None, limit=None, offset=None
        ):
            pass
...
class DataConnector(TestReactorMixin, unittest.TestCase):
    ...
    def test_get_filters(self):
        ...
        gotten = yield self.data.get(
            ("foo",), filters=[resultspec.Filter("val", "lt", [902])]
        )
    ...
    def test_get_resultSpec_args(self):
        ...
        self.assertEqual(
            gotten, base.ListResult([{"val": 919}, {"val": 918}], total=10, limit=2)
        )
        ep.get.assert_called_once_with(mock.ANY, {})
