...
class TimeFunctions(unittest.TestCase):
    def test_UTC(self):
        self.assertEqual(
            util.UTC.utcoffset(datetime.datetime.now()), datetime.timedelta(0)
        )
...
class StripUrlPassword(unittest.TestCase):
    def test_simple_url(self):
        self.assertEqual(
            util.stripUrlPassword("http://foo.com/bar"), "http://foo.com/bar"
        )

    def test_username(self):
        self.assertEqual(
            util.stripUrlPassword("http://d@foo.com/bar"), "http://d@foo.com/bar"
        )
